function init() {
  ...
  // We need to grab a reference to the dropdown select element:
...
// Deliverable 1 - Bar Chart
  ...
  // 1. Create the buildCharts function (that contains the argument sample, which is the sample that is selected from the dropdown menu)
